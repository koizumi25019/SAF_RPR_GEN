...
#define VSIZE_INVALID SIZE_MAX // size_tの最大値を無効値とする
...
#define ERROR_PRINTF(fmt, ...) printf("\x1b[31m" fmt "\x1b[0m", __VA_ARGS__) // 赤

#ifdef _DEBUG
#define DEBUG_PRINTF(fmt, ...) printf("\x1b[32m"fmt"\033[0m", __VA_ARGS__)//緑
#else
