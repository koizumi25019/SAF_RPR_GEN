...
void option(int argc, char *argv[], char **file_names)
{
	...
	if( (i = (int)opt.fsim + (int)opt.xid) > 1){
		printf("\n//-----------------------------------\n");
		printf("// ヽ(*゜д゜)ノ ERROR: Operation Mode\n");
		printf("//-----------------------------------\n");
		printf("下記のコマンドは併用不可!\n");
	...
	if( opt.cpi_xid==YES && opt.fmodel==SAF){
		printf("\n//-----------------------------------\n");
		printf("// ヽ(*゜д゜)ノ ERROR: CPI-XID Mode\n");
		printf("//-----------------------------------\n");
...
{
	fprintf(stderr,"\n//--------------------------------------------------\n");
	fprintf(stderr,"// ヽ(*゜д゜)ノ Command Help \n");
	fprintf(stderr,"//--------------------------------------------------\n");
