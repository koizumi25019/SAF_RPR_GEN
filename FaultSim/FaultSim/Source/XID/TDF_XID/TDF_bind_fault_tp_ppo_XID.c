...
//#pragma warning ( disable : 4996 ) //windows用ということでコメントアウト
...
//	int				count=0;		//t_fault内に何個必須故障を入れたかのカウンタ <- 一度も結果を使用していない変数
