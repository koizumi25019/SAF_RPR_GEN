//------------------------------------------------------------------------
//File name : FPointer_TDF_Long_Fault_Path.c
//Date : 2014/7/25
//Designer : H.Yamazaki
//Ver : 0.01
//------------------------------------------------------------------------
...
//伝搬経路決定
void		TDF_XID_long_fpath_single_gate		(S_NLIST*, int, int, unsigned int, unsigned int, unsigned int);
void		TDF_XID_long_fpath_and				(S_NLIST*, int, int, unsigned int, unsigned int, unsigned int);
void		TDF_XID_long_fpath_nand				(S_NLIST*, int, int, unsigned int, unsigned int, unsigned int);
void		TDF_XID_long_fpath_or				(S_NLIST*, int, int, unsigned int, unsigned int, unsigned int);
void		TDF_XID_long_fpath_nor				(S_NLIST*, int, int, unsigned int, unsigned int, unsigned int);
void		TDF_XID_long_fpath_exor				(S_NLIST*, int, int, unsigned int, unsigned int, unsigned int);
...
//------------------------------------------------------------------------
//----------------------------------------------
//  関数名 : FPointer_TDF_Long_Fault_Path
//  機  能 : 【関数ポインタ作成】TDF用の最大レベルでの故障伝搬経路決定の関数ポインタ作成
//  戻り値 : なし
//  引  数 : なし
//----------------------------------------------
void	FPointer_TDF_Long_Fault_Path(){
	...
	//======================================================================================
	//故障伝搬経路
	sfunc_path[FOUT]	= TDF_XID_long_fpath_single_gate;
	sfunc_path[BUF]		= TDF_XID_long_fpath_single_gate;
	sfunc_path[INV]		= TDF_XID_long_fpath_single_gate;
	sfunc_path[AND]		= TDF_XID_long_fpath_and;
	sfunc_path[NAND]	= TDF_XID_long_fpath_nand;
	sfunc_path[OR]		= TDF_XID_long_fpath_or;
	sfunc_path[NOR]		= TDF_XID_long_fpath_nor;
	sfunc_path[EXOR]	= TDF_XID_long_fpath_exor;
	sfunc_path[EXNOR]	= TDF_XID_long_fpath_exor;
}
...
//★【2値・3値共通】故障伝搬経路★
//------------------------------------------------------------------------------------
//  関数名 : TDF_XID_long_fpath_single_gate
...
//------------------------------------------------------------------------------------
void	TDF_XID_long_fpath_single_gate(S_NLIST *t_net, int tp_id, int fault_id, unsigned int ed_flag, unsigned int xid_flag, unsigned int jus_flag){
...
//------------------------------------------------------------------------------------
//  関数名 : TDF_XID_long_fpath_and
//  機  能 : 【AND】故障伝搬経路決定
//  戻り値 : なし
//  引  数 : t_net(対象信号線), tp_id(テストパターンの何番目か), fault_id(32個中何番目の故障なのか), ed_flag(FSIMイベントフラグ値), xid_flag(X抽出(ケアビット固定)フラグ値)
//------------------------------------------------------------------------------------
void	TDF_XID_long_fpath_and(S_NLIST *t_net, int tp_id, int fault_id, unsigned int ed_flag, unsigned int xid_flag, unsigned int jus_flag){
				...
				if((t_net->in[i]->x_fault & MASKbit[fault_id]) == 0){	//AND入力故障値==0
					...
					if(Get_NBit(t_net->in[i]->xid_nval_t2, tp_id) == 3){	//ドントケア(X)発見
						...
						if(in_lev < t_net->in[i]->level){
							in_lev = t_net->in[i]->level;	//未固定(X)信号線の最大レベルを保存
...
//------------------------------------------------------------------------------------
//  関数名 : TDF_XID_long_fpath_nand
//  機  能 : 【NAND】故障伝搬経路決定
//  戻り値 : なし
//  引  数 : t_net(対象信号線), tp_id(テストパターンの何番目か), fault_id(32個中何番目の故障なのか), ed_flag(FSIMイベントフラグ値), xid_flag(X抽出(ケアビット固定)フラグ値)
//------------------------------------------------------------------------------------
void	TDF_XID_long_fpath_nand(S_NLIST *t_net, int tp_id, int fault_id, unsigned int ed_flag, unsigned int xid_flag, unsigned int jus_flag){
...
//------------------------------------------------------------------------------------
//  関数名 : TDF_XID_long_fpath_or
//  機  能 : 【OR】故障伝搬経路決定
//  戻り値 : なし
//  引  数 : t_net(対象信号線), tp_id(テストパターンの何番目か), fault_id(32個中何番目の故障なのか), ed_flag(FSIMイベントフラグ値), xid_flag(X抽出(ケアビット固定)フラグ値)
//------------------------------------------------------------------------------------
void	TDF_XID_long_fpath_or(S_NLIST *t_net, int tp_id, int fault_id, unsigned int ed_flag, unsigned int xid_flag, unsigned int jus_flag){
...
//------------------------------------------------------------------------------------
//  関数名 : TDF_XID_long_fpath_nor
//  機  能 : 【NOR】故障伝搬経路決定
//  戻り値 : なし
//  引  数 : t_net(対象信号線), tp_id(テストパターンの何番目か), fault_id(32個中何番目の故障なのか), ed_flag(FSIMイベントフラグ値), xid_flag(X抽出(ケアビット固定)フラグ値)
//------------------------------------------------------------------------------------
void	TDF_XID_long_fpath_nor(S_NLIST *t_net, int tp_id, int fault_id, unsigned int ed_flag, unsigned int xid_flag, unsigned int jus_flag){
...
//------------------------------------------------------------------------------------
//  関数名 : TDF_XID_long_fpath_exor
//  機  能 : 【EXOR・EXNOR】故障伝搬経路決定
//  戻り値 : なし
//  引  数 : t_net(対象信号線), tp_id(テストパターンの何番目か), fault_id(32個中何番目の故障なのか), ed_flag(FSIMイベントフラグ値), xid_flag(X抽出(ケアビット固定)フラグ値)
//※2入力のみ対応
//------------------------------------------------------------------------------------
void	TDF_XID_long_fpath_exor(S_NLIST *t_net, int tp_id, int fault_id, unsigned int ed_flag, unsigned int xid_flag, unsigned int jus_flag){
