...
//----------------------------------------------
unsigned int	SAF_3v_EX_xfilling(int tp_id, XID_LIST **t_fault, int n_fault, unsigned int ed_flag, unsigned int xid_flag){
