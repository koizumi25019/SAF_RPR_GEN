...
//----------------------------------------------
unsigned int	TDF_3v_xfilling(int tp_id, SXID_LIST **t_fault, int n_fault, unsigned int ed_flag, unsigned int xid_flag, unsigned int jus_flag){
