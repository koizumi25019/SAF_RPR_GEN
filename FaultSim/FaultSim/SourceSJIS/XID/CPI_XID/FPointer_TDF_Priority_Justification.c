//------------------------------------------------------------------------
//File name : FPointer_TDF_Priority_Justification.c
//Date : 2013/11/21
//Designer : H.Yamazaki
//Ver : 0.01
//------------------------------------------------------------------------
...
//限定正当化
void	TDF_XID_pri_jus_and_nand			(S_NLIST*, int, unsigned int, unsigned int, unsigned int);
void	TDF_XID_pri_jus_or_nor				(S_NLIST*, int, unsigned int, unsigned int, unsigned int);
...
//------------------------------------------------------------------------
//----------------------------------------------
//  関数名 : FPointer_TDF_Priority_Justification
...
void	FPointer_TDF_Priority_Justification(){
	...
	//======================================================================================
	//優先パス限定正当化
	sfunc_prijus[AND]	= TDF_XID_pri_jus_and_nand;		//ANDとNANDは同じ処理
	sfunc_prijus[NAND]	= TDF_XID_pri_jus_and_nand;		//ANDとNANDは同じ処理
	sfunc_prijus[OR]	= TDF_XID_pri_jus_or_nor;		//ORとNORは同じ処理
	sfunc_prijus[NOR]	= TDF_XID_pri_jus_or_nor;		//ORとNORは同じ処理
}
...
//★限定正当化★
//------------------------------------------------------------------------------------
//  関数名 : TDF_XID_pri_jus_and_nand
//  機  能 : 【AND・NAND】2値・3値限定正当化
//  戻り値 : なし
//  引  数 : t_net(対象信号線), tp_id(テストパターンの何番目か), xid_flag(現在のケアビット固定フラグ値), jus_flag(限定正当化フラグ), priority(優先フラグ)
//------------------------------------------------------------------------------------
void	TDF_XID_pri_jus_and_nand(S_NLIST *t_net, int tp_id, unsigned int xid_flag, unsigned int jus_flag, unsigned int priority){
...
//------------------------------------------------------------------------------------
//  関数名 : TDF_XID_pri_jus_or_nor
//  機  能 : 【OR・NOR】2値・3値優先パス限定正当化
//  戻り値 : なし
//  引  数 : t_net(対象信号線), tp_id(テストパターンの何番目か), xid_flag(現在のケアビット固定フラグ値), jus_flag(限定正当化フラグ), priority(優先フラグ)
//------------------------------------------------------------------------------------
void	TDF_XID_pri_jus_or_nor(S_NLIST *t_net, int tp_id, unsigned int xid_flag, unsigned int jus_flag, unsigned int priority){
