...
//伝搬経路決定
void		TDF_XID_pri_fpath_single_gate		(S_NLIST*, int, int, unsigned int, unsigned int, unsigned int, unsigned int);
void		TDF_XID_pri_fpath_and				(S_NLIST*, int, int, unsigned int, unsigned int, unsigned int, unsigned int);
void		TDF_XID_pri_fpath_nand				(S_NLIST*, int, int, unsigned int, unsigned int, unsigned int, unsigned int);
void		TDF_XID_pri_fpath_or				(S_NLIST*, int, int, unsigned int, unsigned int, unsigned int, unsigned int);
void		TDF_XID_pri_fpath_nor				(S_NLIST*, int, int, unsigned int, unsigned int, unsigned int, unsigned int);
void		TDF_XID_pri_fpath_exor				(S_NLIST*, int, int, unsigned int, unsigned int, unsigned int, unsigned int);
...
//------------------------------------------------------------------------
//----------------------------------------------
//  関数名 : FPointer_TDF_Priority_Fault_Path
...
void	FPointer_TDF_Priority_Fault_Path(){
	...
	//======================================================================================
	//故障伝搬経路
	sfunc_pripath[FOUT]		= TDF_XID_pri_fpath_single_gate;
	sfunc_pripath[BUF]		= TDF_XID_pri_fpath_single_gate;
	sfunc_pripath[INV]		= TDF_XID_pri_fpath_single_gate;
	sfunc_pripath[AND]		= TDF_XID_pri_fpath_and;
	sfunc_pripath[NAND]		= TDF_XID_pri_fpath_nand;
	sfunc_pripath[OR]		= TDF_XID_pri_fpath_or;
	sfunc_pripath[NOR]		= TDF_XID_pri_fpath_nor;
	sfunc_pripath[EXOR]		= TDF_XID_pri_fpath_exor;
	sfunc_pripath[EXNOR]	= TDF_XID_pri_fpath_exor;
}
...
//★【2値・3値共通】故障伝搬経路★
//------------------------------------------------------------------------------------
//  関数名 : TDF_XID_pri_fpath_single_gate
...
//------------------------------------------------------------------------------------
void	TDF_XID_pri_fpath_single_gate(S_NLIST *t_net, int tp_id, int fault_id, unsigned int ed_flag, unsigned int xid_flag, unsigned int jus_flag, unsigned int priority){
...
//------------------------------------------------------------------------------------
//  関数名 : TDF_XID_pri_fpath_and
//  機  能 : 【AND】故障伝搬経路決定
//  戻り値 : なし
//  引  数 : t_net(対象信号線), tp_id(テストパターンの何番目か), fault_id(32個中何番目の故障なのか), ed_flag(FSIMイベントフラグ値), xid_flag(X抽出(ケアビット固定)フラグ値), priority(優先フラグ)
//------------------------------------------------------------------------------------
void	TDF_XID_pri_fpath_and(S_NLIST *t_net, int tp_id, int fault_id, unsigned int ed_flag, unsigned int xid_flag, unsigned int jus_flag, unsigned int priority){
...
//------------------------------------------------------------------------------------
//  関数名 : TDF_XID_pri_fpath_nand
//  機  能 : 【NAND】故障伝搬経路決定
//  戻り値 : なし
//  引  数 : t_net(対象信号線), tp_id(テストパターンの何番目か), fault_id(32個中何番目の故障なのか), ed_flag(FSIMイベントフラグ値), xid_flag(X抽出(ケアビット固定)フラグ値), priority(優先フラグ)
//------------------------------------------------------------------------------------
void	TDF_XID_pri_fpath_nand(S_NLIST *t_net, int tp_id, int fault_id, unsigned int ed_flag, unsigned int xid_flag, unsigned int jus_flag, unsigned int priority){
...
//------------------------------------------------------------------------------------
//  関数名 : TDF_XID_pri_fpath_or
//  機  能 : 【OR】故障伝搬経路決定
//  戻り値 : なし
//  引  数 : t_net(対象信号線), tp_id(テストパターンの何番目か), fault_id(32個中何番目の故障なのか), ed_flag(FSIMイベントフラグ値), xid_flag(X抽出(ケアビット固定)フラグ値), priority(優先フラグ)
//------------------------------------------------------------------------------------
void	TDF_XID_pri_fpath_or(S_NLIST *t_net, int tp_id, int fault_id, unsigned int ed_flag, unsigned int xid_flag, unsigned int jus_flag, unsigned int priority){
...
//------------------------------------------------------------------------------------
//  関数名 : TDF_XID_pri_fpath_nor
//  機  能 : 【NOR】故障伝搬経路決定
//  戻り値 : なし
//  引  数 : t_net(対象信号線), tp_id(テストパターンの何番目か), fault_id(32個中何番目の故障なのか), ed_flag(FSIMイベントフラグ値), xid_flag(X抽出(ケアビット固定)フラグ値), priority(優先フラグ)
//------------------------------------------------------------------------------------
void	TDF_XID_pri_fpath_nor(S_NLIST *t_net, int tp_id, int fault_id, unsigned int ed_flag, unsigned int xid_flag, unsigned int jus_flag, unsigned int priority){
...
//------------------------------------------------------------------------------------
//  関数名 : TDF_XID_pri_fpath_exor
//  機  能 : 【EXOR・EXNOR】故障伝搬経路決定
//  戻り値 : なし
//  引  数 : t_net(対象信号線), tp_id(テストパターンの何番目か), fault_id(32個中何番目の故障なのか), ed_flag(FSIMイベントフラグ値), xid_flag(X抽出(ケアビット固定)フラグ値), priority(優先フラグ)
//※2入力のみ対応
//------------------------------------------------------------------------------------
void	TDF_XID_pri_fpath_exor(S_NLIST *t_net, int tp_id, int fault_id, unsigned int ed_flag, unsigned int xid_flag, unsigned int jus_flag, unsigned int priority){
